        ...
        <div class="mt-6 py-3 flex max-w-md gap-x-4">
            ...
            <form class="w-full flex gap-x-4" method="get" action="{{url('/buscar')}}">
                ...
                <input id="buscar" name="buscar" type="search" autocomplete="email" required
                    ...
                    placeholder="Buscar...">
                <button type="submit"
                    class="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Buscar</button>
...
>>>>>>> origin/loginCertificado
                            ...
                            <div class="py-3">
                                ...
                                @if (auth()->check() &&
                                        auth()->user()->postFavorite->contains($post))
                                    <!-- El recurso es favorito para el usuario -->
                                    <form action="{{ route('resources.removeFromFavorites', $post) }}" method="POST">
                                        @csrf
                                ...
                                @else
                                    ...
                                    <form action="{{ route('resources.markAsFavorite', $post) }}" method="POST">
                                        @csrf
                                        ...
                                        <button type="submit"
                                            ...
                                            <img class="transition-rotation duration-300 hover:rotate-45 ease-in-out"
                                                src="{{ asset('img/favorito.png') }}" alt="">
                                        </button>
                                    </form>
                                @endif
